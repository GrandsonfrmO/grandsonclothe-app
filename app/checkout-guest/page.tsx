...
export default function GuestCheckoutPage() {
      ...
      <div className="min-h-screen bg-background pb-24">
        <div className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border">
          <div className="flex items-center gap-4 px-4 py-3">
            ...
            <h1 className="text-xl font-bold">Commande Invité</h1>
          </div>
        </div>
  ...
  const handleSubmitOrder = async () => {
    if (!formData.fullName || !formData.email || !formData.phoneNumber || !formData.deliveryAddress) {
    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border">
        <div className="flex items-center gap-2 sm:gap-4 px-3 sm:px-4 py-2 sm:py-3">
          ...
          <h1 className="text-lg sm:text-xl font-bold">Commande Invité</h1>
        </div>
      </div>
      ...
      <div className="px-3 sm:px-4 py-4 sm:py-6 space-y-3 sm:space-y-6">
        ...
        <div className="bg-card rounded-2xl p-3 sm:p-4 border border-border">
          <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            ...
            <h2 className="text-base sm:text-lg font-bold">Vos informations</h2>
          </div>
