...
import { brandAmbassadors, customerGallery } from '@/lib/db/schema';
...
export async function POST() {
  try {
    ...
    console.log('📸 Ajout des ambassadeurs...');
    ...
    console.log('🖼️  Ajout des images de galerie...');
    ...
    for (const image of galleryImages) {
      await db.insert(customerGallery).values({
